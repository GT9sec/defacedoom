var htmlContent = `
<!DOCTYPE html>
<title>Hacked By gt9 </title>
<link rel="icon" href="" type="image/x-icon"/>
<link rel="shortcut icon" href="" type="image/x-icon"/>
<meta charset="UTF-8">
<body style="background-color: black !important; margin: 0; padding: 0;">
  ...
  <center>
    ...
    <hr>
    <marquee style="font-size: 30px; font-weight: bold; color: green; font-family: 'Iceberg'">Um salve para meus manos!: Cyhp3r - Darui - Slash - Slow - zer0 - UprisingHK - 0xysha - Nano - psychoHKtech - archon</marquee>
  </center>
</body>
</html>
`;
